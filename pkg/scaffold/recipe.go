...
type Recipe struct {
	...
	// ScanTemplates enables automatic discovery of files from the templates directory
	// When true, the Files list is auto-generated by scanning TemplatesDir:
	// - *.tmpl files become template entries (suffix stripped for output path)
	// - .gitkeep files mark directories as empty (create .gitkeep in output)
	// - Other files are copied as-is
	ScanTemplates bool `yaml:"scan_templates,omitempty" json:"scan_templates,omitempty"`
